...
import { ShoppingCart, Zap, Heart, ShieldCheck, MapPin, Truck, Award, Sparkles, MessageSquare } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
        ...
        <div className="md:col-span-3 flex flex-col gap-6">
          ...
          <div className="bg-white border border-slate-100 p-5 rounded">
            ...
            {pincodeStatus && (
              <div className="mt-3 bg-blue-50/50 p-2.5 rounded border border-blue-100 flex items-center gap-2 text-xs text-slate-700 animate-fade-in font-sans">
          ...
          <div className="bg-white border border-slate-100 rounded p-5 flex flex-col gap-4">
            ...
            {specsList.length > 0 && (
              <div>
                ...
                <div className="border border-slate-100 rounded overflow-hidden divide-y divide-slate-100 font-sans">
          ...
          <div className="bg-white border border-slate-100 rounded p-5 flex flex-col gap-5">
            ...
            <form onSubmit={handleReviewSubmission} className="bg-slate-50 border border-slate-100 p-4 rounded flex flex-col gap-3.5">
              ...
              <div className="flex items-center gap-3 font-sans">
                <span className="text-xs text-slate-500 font-bold font-sans">Your Rating:</span>
                <select
                  value={userRating}
              ...
              <textarea
                ...
                className="w-full p-2.5 border rounded text-xs bg-white outline-none placeholder-slate-400 focus:border-primary font-sans"
              />
                ...
                reviewsList.map((rev, idx) => (
                  <div key={idx} className="border-b last:border-b-0 pb-3">
                    <div className="flex items-center gap-2">
                      <span className="bg-[#388E3C] text-white text-[10px] font-bold px-1.5 py-0.5 rounded flex items-center gap-0.5 leading-none px-1.5">
                        {rev.rating}★
                      </span>
                    ...
                    <p className="mt-2 text-xs text-slate-600 leading-normal pl-0.5">
                      {rev.reviewText}
                    </p>
                  </div>
                ))
          ...
          {similarProducts.length > 0 && (
            <div className="bg-white border border-slate-100 rounded p-5">
              <h3 className="text-xs font-bold text-slate-500 uppercase tracking-widest border-b pb-3 mb-4 select-none">
                Similar Products
              </h3>
